...
public class GetTokenUsageStatisticsQueryHandler : IQueryHandler<GetTokenUsageStatisticsQuery, IEnumerable<object>>
{
    ...
    private static IEnumerable<object> GroupByDay(IEnumerable<Infrastructure.Persistence.Entities.TokenUsageRecord> records, 
    ...
    private static IEnumerable<object> GroupByMonth(IEnumerable<Infrastructure.Persistence.Entities.TokenUsageRecord> records,
        DateTimeOffset startDate, DateTimeOffset endDate)
    {
    ...
    private static IEnumerable<object> GroupByModel(IEnumerable<Infrastructure.Persistence.Entities.TokenUsageRecord> records)
    {
        return records
            .GroupBy(r => r.ModelId)
            .Select(g => new
    ...
    private static IEnumerable<object> GroupByUser(IEnumerable<Infrastructure.Persistence.Entities.TokenUsageRecord> records)
    {
        return records
            .GroupBy(r => r.UserId)
            .Select(g => new
    ...
    private static IEnumerable<object> GroupByProvider(IEnumerable<Infrastructure.Persistence.Entities.TokenUsageRecord> records)
    {
        return records
